    ...
    <div class="row" id="basic-table">
        <div class="col-12 col-md-12">
            <div class="card">
                ...
                <div class="card-body">
                    <!-- Form Utama -->
                    <form method="POST" action="<?= base_url('home/aksi_t_penjualan_produk') ?>" id="modalForm">
...
<div class="row align-items-center">
    ...
    <div class="col-md-2 mb-3">
        ...
        <input type="number" class="form-control jumlah" name="jumlah_jual[]" placeholder="Masukkan jumlah" required oninput="calculateTotal(this)" min="0">
    </div>
    ...
    <div class="col-md-2 mb-3">
        <label for="total_bahan">Total:</label>
        <input type="text" class="form-control total-bahan" name="total[]" placeholder="Total" readonly>
    </div>
...
<script>
   document.getElementById('addModalForm').addEventListener('click', function() {
    // Template form yang akan ditambahkan (Dengan kategori)
    let newForm = `
        <div class="modal-form">
            <hr>
            <div class="row align-items-center">
            ...
            <div class="row align-items-center">
                ...
                <div class="col-md-2 mb-3">
                    <label for="jumlah">Jumlah Jual:</label>
                    <input type="number" class="form-control jumlah" name="jumlah_jual[]" placeholder="Masukkan jumlah jual" required oninput="calculateTotal(this)" min="0">
                </div>
    ...
    // Tambahkan form baru ke dalam div #form-container
